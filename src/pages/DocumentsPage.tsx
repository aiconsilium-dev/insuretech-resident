  ...
  return (
    <div className='animate-[fadeIn_0.25s_ease] px-[var(--space-page)] pt-[var(--space-page)] pb-24'>
      ...
      <p className='text-sm text-text-muted mb-6'>
        보험금 청구에 필요한 서류를 제출해주세요
      </p>

      <List className='border border-border'>
        <List.Item>
          <div className='w-10 h-10 rounded-[10px] bg-bg-secondary flex items-center justify-center shrink-0 text-text-muted'>
            ─
          </div>
      ...
      <p className='text-[13px] text-text-muted mt-3.5 leading-relaxed'>
        서류는 보험금 청구 시 필요합니다. 미리 준비해두시면 심사가 빨라집니다.
        사본도 인정됩니다.
      </p>
    </div>
  );
